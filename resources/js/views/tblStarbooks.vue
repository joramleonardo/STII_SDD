<template>
  <div class="container-fluid">
    <h1 class="mt-4 stii-font-color-red">Starbooks</h1>
    <ol class="breadcrumb mb-4">
      <li class="breadcrumb-item active">Home > Starbooks </li>
    </ol>
    <div class="row">
      <div class="col-xl-12">
        <div class="card mb-4">
        ...
        <b-card no-body>
            <b-card bg-variant="light">
                    ...
                    <b-form-group label="Age:" label-for="age" label-cols-sm="2" label-align-sm="right" class="font-weight-700">
                        <b-form-input v-model="employeeData.age" id="age" type="text" placeholder="Enter age here..." required></b-form-input>
                    </b-form-group>
                    <b-form-group label="Designation:" label-for="designation" label-cols-sm="2" label-align-sm="right" class="font-weight-700">
                        <b-form-input v-model="employeeData.designation" id="designation" type="text" placeholder="Enter designation here..." required></b-form-input>
                    </b-form-group>
                    <b-form-group label="Nature:" label-for="nature" label-cols-sm="2" label-align-sm="right" class="font-weight-700"> 
                        <b-form-select v-model="employeeData.nature" id="nature" :options="drop_nature" required></b-form-select>
                    </b-form-group> 
    ...
    <b-modal id="updateEmployeeModal" ref="updateEmployeeModal" title="Add New Employee" hide-footer>
        ...
        <b-card no-body>
            <b-card bg-variant="light">
                    ...
                    <b-form-group label="Age:" label-for="age" label-cols-sm="2" label-align-sm="right" class="font-weight-700">
                        <b-form-input v-model="employeeData_update.age" id="age" type="text" placeholder="Enter age here..." required></b-form-input>
                    </b-form-group>
                    <b-form-group label="Designation:" label-for="designation" label-cols-sm="2" label-align-sm="right" class="font-weight-700">
                        <b-form-input v-model="employeeData_update.designation" id="designation" type="text" placeholder="Enter designation here..." required></b-form-input>
                    </b-form-group>
                    <b-form-group label="Nature:" label-for="nature" label-cols-sm="2" label-align-sm="right" class="font-weight-700"> 
                        <b-form-select v-model="employeeData_update.nature" id="nature" :options="drop_nature" required></b-form-select>
                    </b-form-group> 
                    <b-form-group label="Level:" label-for="level" label-cols-sm="2" label-align-sm="right" class="font-weight-700"> 
                        <b-form-select v-model="employeeData_update.level" id="level" :options="drop_level" required></b-form-select>
                    </b-form-group>
                    <b-form-group label="Division:" label-for="division" label-cols-sm="2" label-align-sm="right" class="font-weight-700"> 
