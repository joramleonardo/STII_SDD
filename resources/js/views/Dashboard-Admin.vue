<template>
  <div class="container-fluid">
    ...
    <ol class="breadcrumb mb-4">
      <li class="breadcrumb-item active">Home > Health and Training</li>
    </ol>
    -->
...
// var chart4;
    ...
    data() {
        return {
            ...
            sortDesc: false,
            fields: [
                { key: 'trainingTitle', label: 'Activity Title', thClass: 'text-left', tdClass: 'text-left'},
                { key: 'trainingType', label: 'Category'},
                { key: 'startDate', label: 'Date'},
                { key: 'totalParticipants', label: 'Total Participants'},
                { key: 'trainingTopic', label: 'Female'},
                { key: 'trainingProvides', label: 'Male'},
                { key: 'created_at', label: 'Conducted By'},
