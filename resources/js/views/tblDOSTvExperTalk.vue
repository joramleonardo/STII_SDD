<template>
  <div class="container-fluid">
    ...
    <ol class="breadcrumb mb-4">
      <li class="breadcrumb-item active">Home > DOSTv > ExperTalk </li>
    </ol>
    <div class="row">
      <div class="col-xl-12">
        <div class="card mb-4">
...
export default {
    ...
    data() {
        return {
            ...
            expertalkFields: [
                ...
                { key: 'dateAired', label: 'Date Aired'},
                // { key: 'socAgenda', label: 'Soc Agenda'},
                { key: 'actions', label: 'Action' }
            ]
            }
    },
    ...
    methods: {
        ...
        loadExpertalk: async function() {
            try{
                const response = await employeeService.loadExpertalk();
